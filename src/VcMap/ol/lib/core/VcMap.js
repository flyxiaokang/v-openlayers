 ...
 * @LastEditTime: 2023-08-17 14:45:37
 */
...
import { MAP_TYPE_ENUM, MOUSE_STATUS_ENUM } from '@/VcMap/global'
// 自定义配置文件
...
class VcMap extends Base {
  ...
  createOverlay({
    ...
    const overlay = this.layerHandler.getOverlayLayer(container)
