 ...
 * @LastEditTime: 2023-08-11 13:50:16
 */
...
import VcMap from '../core/VcMap'
import { getStyle } from '../core/plugins/StyleHandler'

export default class OlHandler extends VcMap {
  ...
  constructor(target = 'ol-map-container') {
    ...
    // 通用 style
    this.defaultCircleStyle = null
    this.defaultIconStyle = null
