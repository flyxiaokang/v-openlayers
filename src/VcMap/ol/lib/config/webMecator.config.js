...
const mapConfig = {
    ...
    baseLayers: [{
            ...
            children: [{
                ...
                children: [{
                    id: 'tdt_vec_w',
                    visible: true,
                    image: new URL('../../v3/assets/image/baseMap/vector.jpg',
        ...
        },
        {
            ...
            children: [{
                ...
                children: [{
                    id: 'tdt_ter_w',
                    visible: false,
                    image: new URL('../../v3/assets/image/baseMap/terrain.jpg',
                    import.meta.url).href,
    ...
    toolbar: [{
        label: "地图选择",
        image: new URL(
            "../../v2/assets/image/toolbar/arrow.png",
            import.meta.url
        ).href,
        key: "pointer",
        visible: true
    },
    {
        label: "放大",
        image: new URL(
            "../../v2/assets/image/toolbar/zoomout.png",
            import.meta.url
        ).href,
        key: "zoomIn",
        visible: true
    },
    {
        label: "缩小",
        image: new URL(
            "../../v2/assets/image/toolbar/zoomin.png",
            import.meta.url
        ).href,
        key: "zoomOut",
        visible: true
    },
    {
        label: "全图",
        image: new URL(
            "../../v2/assets/image/toolbar/home.png",
            import.meta.url
        ).href,
        key: "fullExtent",
        visible: true
    },
    {
        label: "行政区划",
        image: new URL(
            "../../v2/assets/image/toolbar/localed.png",
            import.meta.url
        ).href,
        key: "xzq",
        visible: true
    },
    {
        label: "图层",
        image: new URL(
            "../../v2/assets/image/toolbar/layerC.png",
            import.meta.url
        ).href,
        key: "layer",
        visible: true
    },
    {
        label: "搜索",
        image: new URL(
            "../../v2/assets/image/toolbar/search123.png",
            import.meta.url
        ).href,
        key: "search",
        hasChild: true,
 ...
 
    {
        label: "测距",
        image: new URL(
            "../../v2/assets/image/toolbar/distance-new.png",
            import.meta.url
        ).href,
        key: "LineString",
        visible: true
    },
    {
        label: "测面",
        image: new URL(
            "../../v2/assets/image/toolbar/area-new.png",
            import.meta.url
        ).href,
        key: "Polygon",
        visible: true
    },
    {
        label: "绘制",
        image: new URL(
            "../../v2/assets/image/toolbar/draw.png",
            import.meta.url
        ).href,
        key: "draw",
        visible: true
    },
    {
        label: "清除",
        image: new URL(
            "../../v2/assets/image/toolbar/clear.png",
            import.meta.url
        ).href,
        key: "clear",
        visible: true
