 ...
 * @LastEditTime: 2023-08-17 15:39:58
-->
<template>
  <div
    class="vcmap-container"
  ...
  >
    <!-- map -->
    <div :id="target" class="vcmap-map-view" />
    ...
    <!-- <div class="custom-icon-container" v-if="showIcons">
      <MapIcons />
    </div> -->
  </div>
</template>
...
import MapIcons from './toolbar/MapIcons.vue'
