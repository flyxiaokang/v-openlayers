 ...
 * @LastEditTime: 2023-04-06 22:13:42
-->
<template>
    <div
        id="draggableContainer"
        class="draggable_container_class"
        ref="draggableRef"
        :style="{
    ...
    >
        ...
        >
            ...
            <!-- <el-icon v-if="showCollapseBtn" class="draggableClose" @click="handleCollapse">
                <ArrowUpBold />
            </el-icon> -->
...
export default {
    ...
    methods: {
        ...
        mousedown_bottom: function (e) {
            ...
            let offsetTop = 0
            if (
                document.getElementsByClassName(this.parentClassName).length > 0
            ) {
                offsetTop =
                    document.getElementsByClassName(this.parentClassName)[0]
            ...
            document.onmousemove = function (e) {
                ...
                _self.initPosition.height =
                    parseFloat(curHeight) + (e.pageY - curPageY)
...
.draggable_container_class .slotClass {
    height: 100%;
    width: 100%;
    overflow-y: auto;
    padding-bottom: 2px;
